...
class CollaborationServiceTests {
    ...
    void createFolderRequiresExplicitFolderType() {
        ...
        DomainException exception = assertThrows(
                ...
                () -> collaborationService.createFolder(actorId, new CreateFolderCommand(null, "Name", null)));
    ...
    void createFolderPersistsRequestedType() {
        ...
        FolderView folderView = collaborationService.createFolder(
                actorId,
                new CreateFolderCommand(FolderType.REELS_PLACE, "Wish list", "saved"));
    ...
    void acceptInviteRequiresInviterToRetainWriteCapability() {
        ...
        FolderView folder = collaborationService.createFolder(
                ownerId,
                new CreateFolderCommand(FolderType.PHOTO_DIARY, "Diary", null));

        collaborationStore.saveInvite(com.picturejournal.domain.collaboration.entity.FolderInvite.create(
                UUID.randomUUID(),
                folder.folderId(),
                "invite123",
                FolderRole.VIEWER,
