...
import com.picturejournal.domain.share.repository.FileShareSpikeDraftStore;
...
class ShareSpikeServiceTests {
    ...
    void coldStartRecoveryReloadsPersistedDraft() {
        ShareSpikeDraft created = shareSpikeService.createDraft(new CreateShareSpikeDraftCommand(
                "instagram",
                "ANDROID",
